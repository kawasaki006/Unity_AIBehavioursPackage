...
namespace HybridGOAPExample
{
    public class GOAPAction_UseInteractable : GOAPAction_FSM
    {
        ...
        {
            return 20f; // intentional low cost
        }

        protected override void ConfigureFSM()
        {
            var State_SelectInteractable = LinkedStateMachine.AddState(new SMState_SelectInteraction(SelectIntercationFn));
        ...
        System.Tuple<SmartObject, BaseInteraction> SelectIntercationFn(GameObject InQuerier)
        {
        ...
        protected override void OnStateMachineReset()
        {
            ...
            if (TargetSO != null)
            {
                BaseInteraction TargetIntercation = null;
                LinkedBlackboard.TryGet(CommonCore.Names.Interaction_Type, out TargetIntercation, null);
                if (TargetIntercation != null)
                {
                    TargetIntercation.UnlockInteraction(Self);
                }
            }
