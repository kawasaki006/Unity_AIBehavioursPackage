...
namespace HybridGOAPExample
{
    public class SimpleResourceWrangler : Singleton<SimpleResourceWrangler>, IResourceQueryInterface
    {
        ...
        // find the source with lowest amount to focus on, passing back through callback
        public void RequestResourceFocus(GameObject InQuerier, System.Action<CommonCore.Resources.EType> InCallbackFn)
        {
            ...
            foreach (ResourceContainer Container in AllContainers)
            {
                ...
                // retrieve previous amount of the resource
                float CurrentAmount = 0f;
                ResourceTallies.TryGetValue(Container.ResourceType, out CurrentAmount);
            ...
            // all containers are empty - pick focus randomly
        ...
        // find a source that contains InType resource and available for harvesting, passing back through callback
        ...
        // find a container that can store InType resource, passing back through callback
