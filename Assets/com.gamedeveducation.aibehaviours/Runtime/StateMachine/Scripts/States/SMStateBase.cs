...
namespace StateMachine
{
    public abstract class SMStateBase : ISMState
    {
        ...
        public ESMStateStatus CurrentStatus { get; protected set; } = ESMStateStatus.Uninitialized;
        ...
        protected virtual void GatherDebugDataInternal(IGameDebugger InDebugger, bool bIsSelected)
        {
        ...
        {
            // tick only if this state is running (successfully entered)
