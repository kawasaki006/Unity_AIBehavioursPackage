...
namespace CommonCore
{
    public class Blackboard<BlackboardKeyType>
    {
        ...
        public void Set(BlackboardKeyType InKey, bool InValue)
        {
            BoolValues[InKey] = InValue;
        }
        ...
        public bool TryGet<T>(BlackboardKeyType InKey, out T OutValue, T InDefaultValue = null) where T : MonoBehaviour
        {
            ...
            bool result = TryGet(MonoBehaviourValues, InKey, out tempOutValue, InDefaultValue);
